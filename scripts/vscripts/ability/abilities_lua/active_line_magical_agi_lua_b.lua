active_line_magical_agi_lua_b = class({})

--------------------------------------------------------------------------------

function active_line_magical_agi_lua_b:OnSpellStart()
...
function active_line_magical_agi_lua_b:OnProjectileHit( hTarget, vLocation )
	if hTarget ~= nil and ( not hTarget:IsMagicImmune() ) and ( not hTarget:IsInvulnerable() ) then
		...
		-- local nFXIndex = ParticleManager:CreateParticle( "particles/units/heroes/hero_dragon_knight/dragon_knight_breathe_fire_balls.vpcf", PATTACH_ABSORIGIN_FOLLOW, hTarget )
