active_line_magical_int_lua_b = class({})

--------------------------------------------------------------------------------

function active_line_magical_int_lua_b:OnSpellStart()
...
function active_line_magical_int_lua_b:OnProjectileHit( hTarget, vLocation )
