...
LinkLuaModifier("modifier_imba_nether_blast_debuff", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)

imba_pugna_nether_blast_d = class({})

function imba_pugna_nether_blast_d:IsHiddenWhenStolen() 		return false end
function imba_pugna_nether_blast_d:IsRefreshable() 			return true end
function imba_pugna_nether_blast_d:IsStealable() 				return true end
function imba_pugna_nether_blast_d:IsNetherWardStealable()	return true end
function imba_pugna_nether_blast_d:GetAOERadius() return self:GetSpecialValueFor("radius") end

function imba_pugna_nether_blast_d:OnSpellStart()
	...
	for i=1, blasts do
		...
		Timers:CreateTimer(delay, function()
			...
			local secondary_attr_scale = self:GetSpecialValueFor("secondary_attr_scale")
			for _, ememy_balst in pairs(enemies_balst) do
				...
				local damageTable = {
									victim = ememy_balst,
									attacker = self:GetCaster(),
									damage = secondary_damage + self:GetCaster():GetStrength() * secondary_attr_scale,
									damage_type = self:GetAbilityDamageType(),
									damage_flags = DOTA_DAMAGE_FLAG_NONE, --Optional.
									ability = self, --Optional.
									}
...
imba_pugna_nether_blast_c = class({})

function imba_pugna_nether_blast_c:IsHiddenWhenStolen() 		return false end
function imba_pugna_nether_blast_c:IsRefreshable() 			return true end
function imba_pugna_nether_blast_c:IsStealable() 				return true end
function imba_pugna_nether_blast_c:IsNetherWardStealable()	return true end
function imba_pugna_nether_blast_c:GetAOERadius() return self:GetSpecialValueFor("radius") end

function imba_pugna_nether_blast_c:OnSpellStart()
	local caster = self:GetCaster()
	local pos = self:GetCursorPosition()
	local blasts = self:GetSpecialValueFor("secondary_blasts")
	local radius = self:GetSpecialValueFor("radius")
...
imba_pugna_nether_blast_b = class({})

function imba_pugna_nether_blast_b:IsHiddenWhenStolen() 		return false end
function imba_pugna_nether_blast_b:IsRefreshable() 			return true end
function imba_pugna_nether_blast_b:IsStealable() 				return true end
function imba_pugna_nether_blast_b:IsNetherWardStealable()	return true end
function imba_pugna_nether_blast_b:GetAOERadius() return self:GetSpecialValueFor("radius") end

function imba_pugna_nether_blast_b:OnSpellStart()
	local caster = self:GetCaster()
	local pos = self:GetCursorPosition()
	local blasts = self:GetSpecialValueFor("secondary_blasts")
	local radius = self:GetSpecialValueFor("radius")
...
imba_pugna_nether_blast_a = class({})

function imba_pugna_nether_blast_a:IsHiddenWhenStolen() 		return false end
function imba_pugna_nether_blast_a:IsRefreshable() 			return true end
function imba_pugna_nether_blast_a:IsStealable() 				return true end
function imba_pugna_nether_blast_a:IsNetherWardStealable()	return true end
function imba_pugna_nether_blast_a:GetAOERadius() return self:GetSpecialValueFor("radius") end

function imba_pugna_nether_blast_a:OnSpellStart()
	local caster = self:GetCaster()
	local pos = self:GetCursorPosition()
	local blasts = self:GetSpecialValueFor("secondary_blasts")
	local radius = self:GetSpecialValueFor("radius")
...
function modifier_imba_nether_blast_debuff:GetModifierMoveSpeedBonus_Percentage() return (0 - (self:GetAbility():GetSpecialValueFor("slow_tooltip") or 0)) end
function modifier_imba_nether_blast_debuff:GetModifierMagicalResistanceBonus() return (0 - (self:GetAbility():GetSpecialValueFor("magic_amp_tooltip") or 0)) end
...
LinkLuaModifier("modifier_imba_decrepify_ally", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_decrepify_enemy", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_decrepify_ally:OnDestroy()
	if IsServer() then
		local ability = (self:GetCaster():FindAbilityByName("imba_pugna_nether_blast_d") or self:GetCaster():FindAbilityByName("imba_pugna_nether_blast_c") or self:GetCaster():FindAbilityByName("imba_pugna_nether_blast_b") or self:GetCaster():FindAbilityByName("imba_pugna_nether_blast_a"))
		if not ability then
			return
		end
...
LinkLuaModifier("modifier_imba_nether_ward", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_nether_ward_debuff", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_life_drain_enemy", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_life_drain_friend", "ability/abilities_lua/hero_pugna", LUA_MODIFIER_MOTION_NONE)
