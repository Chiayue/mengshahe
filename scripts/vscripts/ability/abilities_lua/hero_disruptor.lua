...
LinkLuaModifier("modifier_imba_thunder_strike", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)

imba_disruptor_thunder_strike_c = class({})

function imba_disruptor_thunder_strike_c:IsHiddenWhenStolen() 	return false end
function imba_disruptor_thunder_strike_c:IsRefreshable() 			return true end
function imba_disruptor_thunder_strike_c:IsStealable() 			return true end
function imba_disruptor_thunder_strike_c:IsNetherWardStealable()	return true end
function imba_disruptor_thunder_strike_c:GetAOERadius() return self:GetSpecialValueFor("cast_radius") end

function imba_disruptor_thunder_strike_c:OnSpellStart()
...
imba_disruptor_thunder_strike_b = class({})

function imba_disruptor_thunder_strike_b:IsHiddenWhenStolen() 	return false end
function imba_disruptor_thunder_strike_b:IsRefreshable() 			return true end
function imba_disruptor_thunder_strike_b:IsStealable() 			return true end
function imba_disruptor_thunder_strike_b:IsNetherWardStealable()	return true end
function imba_disruptor_thunder_strike_b:GetAOERadius() return self:GetSpecialValueFor("cast_radius") end

function imba_disruptor_thunder_strike_b:OnSpellStart()
	local caster = self:GetCaster()
	caster:EmitSound("Hero_Disruptor.ThunderStrike.Cast")
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
...
imba_disruptor_thunder_strike_a = class({})

function imba_disruptor_thunder_strike_a:IsHiddenWhenStolen() 	return false end
function imba_disruptor_thunder_strike_a:IsRefreshable() 			return true end
function imba_disruptor_thunder_strike_a:IsStealable() 			return true end
function imba_disruptor_thunder_strike_a:IsNetherWardStealable()	return true end
function imba_disruptor_thunder_strike_a:GetAOERadius() return self:GetSpecialValueFor("cast_radius") end

function imba_disruptor_thunder_strike_a:OnSpellStart()
	local caster = self:GetCaster()
	caster:EmitSound("Hero_Disruptor.ThunderStrike.Cast")
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
...
function modifier_imba_thunder_strike:OnIntervalThink()
	...
	local attr_scale = ability:GetSpecialValueFor("attr_scale")
	for i=1, #enemy do
		ApplyDamage({victim = enemy[i], attacker = caster, ability = ability, damage = ability:GetSpecialValueFor("strike_damage") + caster:GetStrength()*attr_scale, damage_type = ability:GetAbilityDamageType()})
	end
end
...
LinkLuaModifier("modifier_imba_glimpse_built_in", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_glimpse_record", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_glimpse_target", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_kinetic_field_delay", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_kinetic_field_thinker", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_kinetic_field", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_static_storm_thinker", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_static_storm_debuff", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_static_storm_motion", "ability/abilities_lua/hero_disruptor.lua", LUA_MODIFIER_MOTION_NONE)
