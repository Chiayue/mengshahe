active_line_magical_int_lua_a = class({})

--------------------------------------------------------------------------------

function active_line_magical_int_lua_a:OnSpellStart()
...
function active_line_magical_int_lua_a:OnProjectileHit( hTarget, vLocation )
