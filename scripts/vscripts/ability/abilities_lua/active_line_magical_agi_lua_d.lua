active_line_magical_agi_lua_d = class({})

--------------------------------------------------------------------------------

function active_line_magical_agi_lua_d:OnSpellStart()
...
function active_line_magical_agi_lua_d:OnProjectileHit( hTarget, vLocation )
