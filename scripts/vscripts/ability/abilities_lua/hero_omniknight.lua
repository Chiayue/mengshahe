...
LinkLuaModifier("modifier_imba_purification_passive", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_purification_passive_cooldown", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_imba_a", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_b", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_c", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_d", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)

imba_omniknight_purification_d = class({})

function imba_omniknight_purification_d:IsHiddenWhenStolen() 		return false end
function imba_omniknight_purification_d:IsRefreshable() 			return true end
function imba_omniknight_purification_d:IsStealable() 			return true end
function imba_omniknight_purification_d:IsNetherWardStealable()	return true end
function imba_omniknight_purification_d:GetAOERadius() return self:GetSpecialValueFor("radius") end

-- function imba_omniknight_purification_d:GetIntrinsicModifierName() return "modifier_imba_purification_passive" end

function imba_omniknight_purification_d:OnSpellStart()
	...
	local end_dmg = heal * (self:GetSpecialValueFor("damage_factor") / 100)
	if end_dmg >= 100000 then
		end_dmg = 100000
	end
...
imba_omniknight_purification_c = class({})

function imba_omniknight_purification_c:IsHiddenWhenStolen() 		return false end
function imba_omniknight_purification_c:IsRefreshable() 			return true end
function imba_omniknight_purification_c:IsStealable() 			return true end
function imba_omniknight_purification_c:IsNetherWardStealable()	return true end
function imba_omniknight_purification_c:GetAOERadius() return self:GetSpecialValueFor("radius") end

-- function imba_omniknight_purification_c:GetIntrinsicModifierName() return "modifier_imba_purification_passive" end

function imba_omniknight_purification_c:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	target:EmitSound("Hero_Omniknight.Purification")
	local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_omniknight/omniknight_purification_cast.vpcf", PATTACH_POINT_FOLLOW, caster)
...
imba_omniknight_purification_b = class({})

function imba_omniknight_purification_b:IsHiddenWhenStolen() 		return false end
function imba_omniknight_purification_b:IsRefreshable() 			return true end
function imba_omniknight_purification_b:IsStealable() 			return true end
function imba_omniknight_purification_b:IsNetherWardStealable()	return true end
function imba_omniknight_purification_b:GetAOERadius() return self:GetSpecialValueFor("radius") end

-- function imba_omniknight_purification_b:GetIntrinsicModifierName() return "modifier_imba_purification_passive" end

function imba_omniknight_purification_b:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	target:EmitSound("Hero_Omniknight.Purification")
	local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_omniknight/omniknight_purification_cast.vpcf", PATTACH_POINT_FOLLOW, caster)
...
imba_omniknight_purification_a = class({})

function imba_omniknight_purification_a:IsHiddenWhenStolen() 		return false end
function imba_omniknight_purification_a:IsRefreshable() 			return true end
function imba_omniknight_purification_a:IsStealable() 			return true end
function imba_omniknight_purification_a:IsNetherWardStealable()	return true end
function imba_omniknight_purification_a:GetAOERadius() return self:GetSpecialValueFor("radius") end

-- function imba_omniknight_purification_a:GetIntrinsicModifierName() return "modifier_imba_purification_passive" end

function imba_omniknight_purification_a:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	target:EmitSound("Hero_Omniknight.Purification")
	local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_omniknight/omniknight_purification_cast.vpcf", PATTACH_POINT_FOLLOW, caster)
...
imba_omniknight_purification_s = class({})

function imba_omniknight_purification_s:IsHiddenWhenStolen() 		return false end
function imba_omniknight_purification_s:IsRefreshable() 			return true end
function imba_omniknight_purification_s:IsStealable() 			return true end
function imba_omniknight_purification_s:IsNetherWardStealable()	return true end
function imba_omniknight_purification_s:GetAOERadius() return self:GetSpecialValueFor("radius") end

-- function imba_omniknight_purification_s:GetIntrinsicModifierName() return "modifier_imba_purification_passive" end

function imba_omniknight_purification_s:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	target:EmitSound("Hero_Omniknight.Purification")
	local pfx = ParticleManager:CreateParticle("particles/units/heroes/hero_omniknight/omniknight_purification_cast.vpcf", PATTACH_POINT_FOLLOW, caster)
...
LinkLuaModifier("modifier_imba_repel", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_degen_aura_passive", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_degen_aura_stacks", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_guardian_angel", "ability/abilities_lua/hero_omniknight", LUA_MODIFIER_MOTION_NONE)
...
function imba_omniknight_guardian_angel:OnSpellStart()
	...
	for _, unit in pairs(units) do
		...
		local buff1 = unit:FindModifierByName("modifier_imba_guardian_angel")
		if buff1 then
			buff1:SetStackCount(0)
			buff1:Destroy()
		end		
...
function modifier_imba_guardian_angel:OnCreated()
	if IsServer() then
		self:SetStackCount(self:GetAbility():GetSpecialValueFor("damage_block"))
	end
end
function modifier_imba_guardian_angel:OnTakeDamage(keys)
	if keys.unit ~= self:GetParent() then
		return 
	end
	if IsServer() then
