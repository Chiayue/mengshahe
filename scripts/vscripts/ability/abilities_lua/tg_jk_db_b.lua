tg_jk_db_b=tg_jk_db_b or class({})
...
function tg_jk_db_b:IsHiddenWhenStolen() 
    return false 
end

function tg_jk_db_b:IsStealable() 
    return true 
end

function tg_jk_db_b:IsNetherWardStealable() 
    return true 
end

function tg_jk_db_b:IsRefreshable() 			
    return true 
end

function tg_jk_db_b:ProcsMagicStick() 			
    return true 
end

function tg_jk_db_b:OnSpellStart()
...
function tg_jk_db_b:OnProjectileHit_ExtraData(target, location, kv)
