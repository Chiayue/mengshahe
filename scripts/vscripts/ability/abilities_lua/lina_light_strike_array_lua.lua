...
LinkLuaModifier( "modifier_lina_light_strike_array_lua","ability/abilities_lua/modifier/modifier_lina_light_strike_array_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lina_light_strike_array_thinker_lua","ability/abilities_lua/modifier/modifier_lina_light_strike_array_thinker_lua", LUA_MODIFIER_MOTION_NONE )
