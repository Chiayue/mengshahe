...
LinkLuaModifier("modifier_imba_time_walk_slow", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_time_walk_buff", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_time_walk_motion", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_time_walk_damage", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_time_walk_damage_counter", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
...
function imba_faceless_void_time_walk:GetCooldown(i) return (self:GetCaster():HasScepter() and (self.BaseClass.GetCooldown(self, i)) or self.BaseClass.GetCooldown(self, i)) end
...
function modifier_imba_time_walk_buff:GetModifierMoveSpeedBonus_Percentage() 
	if self.move_bonus==nil then
		return
	end	
	return (self:GetStackCount() * self.move_bonus) 
end
function modifier_imba_time_walk_buff:GetModifierAttackSpeedBonus_Constant() 
...
function modifier_imba_time_walk_buff:OnRemoved() 
	if not IsServer() then
		return
		end
		self.move_bonus=nil
...
LinkLuaModifier("modifier_imba_time_dilation_slow", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_time_dilation_buff", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_faceless_void_time_lock_passive", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_faceless_void_time_lock_reduce", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)

imba_faceless_void_time_lock_b = class({})

function imba_faceless_void_time_lock_b:GetIntrinsicModifierName() return "modifier_imba_faceless_void_time_lock_passive" end

imba_faceless_void_time_lock_a = class({})

function imba_faceless_void_time_lock_a:GetIntrinsicModifierName() return "modifier_imba_faceless_void_time_lock_passive" end

imba_faceless_void_time_lock_s = class({})

function imba_faceless_void_time_lock_s:GetIntrinsicModifierName() return "modifier_imba_faceless_void_time_lock_passive" end
	...
	if PseudoRandom:RollPseudoRandom(self:GetAbility(), self:GetAbility():GetSpecialValueFor("bash_chance")) then
		...
		for _, enemy in pairs(enemies) do
			local damageTable = {
								...
								damage = self:GetAbility():GetSpecialValueFor("bash_damage") + self:GetParent():GetStrength() * attr_scale,
...
LinkLuaModifier("modifier_imba_faceless_void_timelord_thinker", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_faceless_void_chronosphere_aoe", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_faceless_void_chronosphere_thinker", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_faceless_void_chronosphere_debuff", "ability/abilities_lua/hero_faceless_void", LUA_MODIFIER_MOTION_NONE)
