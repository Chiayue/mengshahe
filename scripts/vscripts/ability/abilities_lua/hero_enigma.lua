...
LinkLuaModifier("modifier_imba_enigma_malefice", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_malefice_motion", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)


imba_enigma_malefice_c = class({})

function imba_enigma_malefice_c:IsHiddenWhenStolen() 		return false end
function imba_enigma_malefice_c:IsRefreshable() 			return true  end
function imba_enigma_malefice_c:IsStealable() 			return true  end
function imba_enigma_malefice_c:IsNetherWardStealable() 	return true end

function imba_enigma_malefice_c:GetAOERadius() return self:GetSpecialValueFor("glitch_radius") end

function imba_enigma_malefice_c:OnSpellStart()
...
imba_enigma_malefice_b = class({})

function imba_enigma_malefice_b:IsHiddenWhenStolen() 		return false end
function imba_enigma_malefice_b:IsRefreshable() 			return true  end
function imba_enigma_malefice_b:IsStealable() 			return true  end
function imba_enigma_malefice_b:IsNetherWardStealable() 	return true end

function imba_enigma_malefice_b:GetAOERadius() return self:GetSpecialValueFor("glitch_radius") end

function imba_enigma_malefice_b:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
		return
...
imba_enigma_malefice_a = class({})

function imba_enigma_malefice_a:IsHiddenWhenStolen() 		return false end
function imba_enigma_malefice_a:IsRefreshable() 			return true  end
function imba_enigma_malefice_a:IsStealable() 			return true  end
function imba_enigma_malefice_a:IsNetherWardStealable() 	return true end

function imba_enigma_malefice_a:GetAOERadius() return self:GetSpecialValueFor("glitch_radius") end

function imba_enigma_malefice_a:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
		return
...
imba_enigma_malefice_s = class({})

function imba_enigma_malefice_s:IsHiddenWhenStolen() 		return false end
function imba_enigma_malefice_s:IsRefreshable() 			return true  end
function imba_enigma_malefice_s:IsStealable() 			return true  end
function imba_enigma_malefice_s:IsNetherWardStealable() 	return true end

function imba_enigma_malefice_s:GetAOERadius() return self:GetSpecialValueFor("glitch_radius") end

function imba_enigma_malefice_s:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
		return
...
function modifier_imba_enigma_malefice:OnCreated()
	if IsServer() then
		self:StartIntervalThink((self:GetAbility():GetSpecialValueFor("tick_interval") or 0))
...
function modifier_imba_enigma_malefice:OnIntervalThink()
	...
	local enemy = FindUnitsInRadius(self:GetCaster():GetTeamNumber(), self:GetParent():GetAbsOrigin(), nil, (self:GetAbility():GetSpecialValueFor("glitch_radius") or 0), DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC, DOTA_UNIT_TARGET_FLAG_NONE, FIND_ANY_ORDER, false)
	...
	for i=1, #enemy do
		...
		local damageTable = {
							...
							damage = self:GetAbility():GetSpecialValueFor("tick_damage") + self:GetCaster():GetStrength() * attr_scale,
...
LinkLuaModifier("modifier_imba_enigma_demonic_conversion_attack_count", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_demonic_conversion_buff", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_enigma_midnight_pulse_thinker", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_midnight_pulse_motion", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_enigma_gravity_passive", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_gravity_aura", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_enigma_black_hole_singularity", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_black_hole_thinker", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_black_hole_out_pull", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_enigma_black_hole_aura", "ability/abilities_lua/hero_enigma", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_enigma_black_hole_thinker:OnCreated()
	if IsServer() then
		...
		if HeroItems:UnitHasItem(self:GetCaster(), "rubick_arcana") then
			hole_pfx = "particles/units/heroes/hero_rubick/rubick_blackhole.vpcf"
		end
