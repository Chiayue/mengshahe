tg_jk_db_a=tg_jk_db_a or class({})
...
function tg_jk_db_a:IsHiddenWhenStolen() 
    return false 
end

function tg_jk_db_a:IsStealable() 
    return true 
end

function tg_jk_db_a:IsNetherWardStealable() 
    return true 
end

function tg_jk_db_a:IsRefreshable() 			
    return true 
end

function tg_jk_db_a:ProcsMagicStick() 			
    return true 
end

function tg_jk_db_a:OnSpellStart()
...
function tg_jk_db_a:OnProjectileHit_ExtraData(target, location, kv)
