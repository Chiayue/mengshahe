...
LinkLuaModifier("modifier_imba_crystal_nova_slow", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_nova_thinker", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_crystal_nova_snowfield_buff", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_frostbite_root", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_frostbite_passive", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_frostbite_passive_cooldown", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_brilliance_aura_passive", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_brilliance_aura_effect", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_freezing_field_particle", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_freezing_field_thinker", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_freezing_field_debuff", "ability/abilities_lua/hero_crystal_maiden", LUA_MODIFIER_MOTION_NONE)

imba_crystal_maiden_freezing_field_b = class({})

function imba_crystal_maiden_freezing_field_b:IsHiddenWhenStolen() 	return false end
function imba_crystal_maiden_freezing_field_b:IsRefreshable() 		return true  end
function imba_crystal_maiden_freezing_field_b:IsStealable() 			return true  end
function imba_crystal_maiden_freezing_field_b:IsNetherWardStealable()	return true end

function imba_crystal_maiden_freezing_field_b:GetCastRange(vLocation, hTarget)
...
function imba_crystal_maiden_freezing_field_b:GetChannelTime() return self:GetSpecialValueFor("duration") end

function imba_crystal_maiden_freezing_field_b:GetAOERadius() return self:GetSpecialValueFor("radius") + self:GetCaster():GetTalentValue("special_bonus_imba_crystal_maiden_2") end

function imba_crystal_maiden_freezing_field_b:GetBehavior()
...
function imba_crystal_maiden_freezing_field_b:OnSpellStart()
	local caster = self:GetCaster()
	local pos = self:GetCursorPosition()
	...
	-- print(">>>>>>>>>>>>>>>>>>>>>> OnSpellStart >>>>>>>>>>>>>>>>>>>>>>>")
	-- EmitSoundOn("Imba.CrystalMaidenLetItGo01", caster)	
end

imba_crystal_maiden_freezing_field_a = class({})

function imba_crystal_maiden_freezing_field_a:IsHiddenWhenStolen() 	return false end
function imba_crystal_maiden_freezing_field_a:IsRefreshable() 		return true  end
function imba_crystal_maiden_freezing_field_a:IsStealable() 			return true  end
function imba_crystal_maiden_freezing_field_a:IsNetherWardStealable()	return true end

function imba_crystal_maiden_freezing_field_a:GetCastRange(vLocation, hTarget)
	if self:GetCaster():HasScepter() then
		return self:GetSpecialValueFor("radius")
	else
		return self:GetSpecialValueFor("radius") - self:GetCaster():GetCastRangeBonus() + self:GetCaster():GetTalentValue("special_bonus_imba_crystal_maiden_2")
...
function imba_crystal_maiden_freezing_field_a:GetChannelTime() return self:GetSpecialValueFor("duration") end

function imba_crystal_maiden_freezing_field_a:GetAOERadius() return self:GetSpecialValueFor("radius") + self:GetCaster():GetTalentValue("special_bonus_imba_crystal_maiden_2") end

function imba_crystal_maiden_freezing_field_a:GetBehavior()
	if not self:GetCaster():HasScepter() then
		return DOTA_ABILITY_BEHAVIOR_NO_TARGET + DOTA_ABILITY_BEHAVIOR_CHANNELLED + DOTA_ABILITY_BEHAVIOR_DONT_RESUME_ATTACK
	else
		return DOTA_ABILITY_BEHAVIOR_POINT + DOTA_ABILITY_BEHAVIOR_CHANNELLED + DOTA_ABILITY_BEHAVIOR_DONT_RESUME_ATTACK + DOTA_ABILITY_BEHAVIOR_AOE
...
function imba_crystal_maiden_freezing_field_a:OnSpellStart()
	local caster = self:GetCaster()
	local pos = self:GetCursorPosition()
	local scepter = caster:HasScepter()
	caster:AddNewModifier(caster, self, "modifier_imba_freezing_field_particle", {duration = self:GetSpecialValueFor("duration")})
...
function modifier_imba_freezing_field_thinker:OnIntervalThink()
	...
	dmg = self:GetCaster():GetIntellect() * self:GetAbility():GetSpecialValueFor("attr_scale")
...
function modifier_imba_freezing_field_thinker:OnDestroy()
	if IsServer() then
		...
		StopSoundOn("Imba.CrystalMaidenLetItGo01", self:GetCaster())	
	end
end
