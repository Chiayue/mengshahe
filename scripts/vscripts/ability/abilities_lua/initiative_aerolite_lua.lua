initiative_aerolite_lua = class({})

function initiative_aerolite_lua:OnSpellStart()
...
function initiative_aerolite_lua:OnProjectileHit( hTarget, vLocation )

	if self:GetCaster() ~= nil and hTarget ~= nil and ( not hTarget:IsMagicImmune() ) and ( not hTarget:IsInvulnerable() ) then
