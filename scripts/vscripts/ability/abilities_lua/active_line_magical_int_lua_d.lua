active_line_magical_int_lua_d = class({})

--------------------------------------------------------------------------------

function active_line_magical_int_lua_d:OnSpellStart()
...
function active_line_magical_int_lua_d:OnProjectileHit( hTarget, vLocation )
