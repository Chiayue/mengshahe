...
LinkLuaModifier("modifier_imba_lina_dragon_slave_thinker", "ability/abilities_lua/hero_lina", LUA_MODIFIER_MOTION_NONE)

imba_lina_dragon_slave_d = class({})

function imba_lina_dragon_slave_d:IsHiddenWhenStolen() 		return false end
function imba_lina_dragon_slave_d:IsRefreshable() 			return true  end
function imba_lina_dragon_slave_d:IsStealable() 				return true  end
function imba_lina_dragon_slave_d:IsNetherWardStealable()		return true end
function imba_lina_dragon_slave_d:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_dragon_slave_d:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_dragon_slave_d:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_dragon_slave_fiery" or "lina_dragon_slave" end

function imba_lina_dragon_slave_d:OnSpellStart()
...
function imba_lina_dragon_slave_d:OnProjectileThink_ExtraData(location, keys)
	local thinker = EntIndexToHScript(keys.thinker)
	local super = keys.super
	thinker:SetOrigin(location)
end

function imba_lina_dragon_slave_d:OnProjectileHit_ExtraData(target, location, keys)
	if target then
		return false
	end
...
imba_lina_dragon_slave_c = class({})

function imba_lina_dragon_slave_c:IsHiddenWhenStolen() 		return false end
function imba_lina_dragon_slave_c:IsRefreshable() 			return true  end
function imba_lina_dragon_slave_c:IsStealable() 				return true  end
function imba_lina_dragon_slave_c:IsNetherWardStealable()		return true end
function imba_lina_dragon_slave_c:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_dragon_slave_c:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_dragon_slave_c:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_dragon_slave_fiery" or "lina_dragon_slave" end

function imba_lina_dragon_slave_c:OnSpellStart()
	local caster = self:GetCaster()
	EmitSoundOnLocationWithCaster(caster:GetAbsOrigin(), "Hero_Lina.DragonSlave.Cast", caster)
	local pos = self:GetCursorPosition()
	local direction = (pos - caster:GetAbsOrigin()):Normalized()
...
function imba_lina_dragon_slave_c:OnProjectileThink_ExtraData(location, keys)
	local thinker = EntIndexToHScript(keys.thinker)
	local super = keys.super
	thinker:SetOrigin(location)
end

function imba_lina_dragon_slave_c:OnProjectileHit_ExtraData(target, location, keys)
	if target then
		return false
	end
...
imba_lina_dragon_slave_b = class({})

function imba_lina_dragon_slave_b:IsHiddenWhenStolen() 		return false end
function imba_lina_dragon_slave_b:IsRefreshable() 			return true  end
function imba_lina_dragon_slave_b:IsStealable() 				return true  end
function imba_lina_dragon_slave_b:IsNetherWardStealable()		return true end
function imba_lina_dragon_slave_b:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_dragon_slave_b:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_dragon_slave_b:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_dragon_slave_fiery" or "lina_dragon_slave" end

function imba_lina_dragon_slave_b:OnSpellStart()
	local caster = self:GetCaster()
	EmitSoundOnLocationWithCaster(caster:GetAbsOrigin(), "Hero_Lina.DragonSlave.Cast", caster)
	local pos = self:GetCursorPosition()
	local direction = (pos - caster:GetAbsOrigin()):Normalized()
...
function imba_lina_dragon_slave_b:OnProjectileThink_ExtraData(location, keys)
	local thinker = EntIndexToHScript(keys.thinker)
	local super = keys.super
	thinker:SetOrigin(location)
end
...
imba_lina_dragon_slave_a = class({})

function imba_lina_dragon_slave_a:IsHiddenWhenStolen() 		return false end
function imba_lina_dragon_slave_a:IsRefreshable() 			return true  end
function imba_lina_dragon_slave_a:IsStealable() 				return true  end
function imba_lina_dragon_slave_a:IsNetherWardStealable()		return true end
function imba_lina_dragon_slave_a:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_dragon_slave_a:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_dragon_slave_a:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_dragon_slave_fiery" or "lina_dragon_slave" end

function imba_lina_dragon_slave_a:OnSpellStart()
	local caster = self:GetCaster()
	EmitSoundOnLocationWithCaster(caster:GetAbsOrigin(), "Hero_Lina.DragonSlave.Cast", caster)
	local pos = self:GetCursorPosition()
	local direction = (pos - caster:GetAbsOrigin()):Normalized()
...
function imba_lina_dragon_slave_a:OnProjectileThink_ExtraData(location, keys)
	local thinker = EntIndexToHScript(keys.thinker)
	local super = keys.super
	thinker:SetOrigin(location)
end

function imba_lina_dragon_slave_a:OnProjectileHit_ExtraData(target, location, keys)
	if target then
		return false
	end
...
LinkLuaModifier("modifier_imba_lina_light_strike_array_thinker_mom", "ability/abilities_lua/hero_lina", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_lina_light_strike_array_thinker_son", "ability/abilities_lua/hero_lina", LUA_MODIFIER_MOTION_NONE)

imba_lina_light_strike_array_c = class({})

function imba_lina_light_strike_array_c:IsHiddenWhenStolen() 		return false end
function imba_lina_light_strike_array_c:IsRefreshable() 			return true end
function imba_lina_light_strike_array_c:IsStealable() 			return true end
function imba_lina_light_strike_array_c:IsNetherWardStealable()	return true end
function imba_lina_light_strike_array_c:GetAOERadius() return self:GetSpecialValueFor("aoe_radius") end
function imba_lina_light_strike_array_c:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_light_strike_array_c:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_light_strike_array_c:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_light_strike_array_fiery" or "lina_light_strike_array" end

function imba_lina_light_strike_array_c:OnSpellStart()
	local caster = self:GetCaster()
...
imba_lina_light_strike_array_b = class({})

function imba_lina_light_strike_array_b:IsHiddenWhenStolen() 		return false end
function imba_lina_light_strike_array_b:IsRefreshable() 			return true end
function imba_lina_light_strike_array_b:IsStealable() 			return true end
function imba_lina_light_strike_array_b:IsNetherWardStealable()	return true end
function imba_lina_light_strike_array_b:GetAOERadius() return self:GetSpecialValueFor("aoe_radius") end
function imba_lina_light_strike_array_b:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_light_strike_array_b:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_light_strike_array_b:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_light_strike_array_fiery" or "lina_light_strike_array" end

function imba_lina_light_strike_array_b:OnSpellStart()
	local caster = self:GetCaster()
	local pos = caster:GetAbsOrigin() + (self:GetCursorPosition() - caster:GetAbsOrigin()):Normalized() * (self:GetCastRange(Vector(0,0,0), caster) + caster:GetCastRangeBonus())
	local start_pos = caster:GetAbsOrigin() + (self:GetCursorPosition() - caster:GetAbsOrigin()):Normalized() * self:GetSpecialValueFor("aoe_radius")
	local super_state = self:HasFireSoulActive() and 1 or 0
...
imba_lina_light_strike_array_a = class({})

function imba_lina_light_strike_array_a:IsHiddenWhenStolen() 		return false end
function imba_lina_light_strike_array_a:IsRefreshable() 			return true end
function imba_lina_light_strike_array_a:IsStealable() 			return true end
function imba_lina_light_strike_array_a:IsNetherWardStealable()	return true end
function imba_lina_light_strike_array_a:GetAOERadius() return self:GetSpecialValueFor("aoe_radius") end
function imba_lina_light_strike_array_a:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_light_strike_array_a:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_light_strike_array_a:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_light_strike_array_fiery" or "lina_light_strike_array" end

function imba_lina_light_strike_array_a:OnSpellStart()
	local caster = self:GetCaster()
	local pos = caster:GetAbsOrigin() + (self:GetCursorPosition() - caster:GetAbsOrigin()):Normalized() * (self:GetCastRange(Vector(0,0,0), caster) + caster:GetCastRangeBonus())
	local start_pos = caster:GetAbsOrigin() + (self:GetCursorPosition() - caster:GetAbsOrigin()):Normalized() * self:GetSpecialValueFor("aoe_radius")
	local super_state = self:HasFireSoulActive() and 1 or 0
	...
	if IsServer() then
		...
		for _, enemy in pairs(enemies) do
			local damageTable = {
								victim = enemy,
								attacker = self:GetCaster(),
								damage = self:GetAbility():GetSpecialValueFor("damage") + self:GetCaster():GetStrength() * attr_scale,
								damage_type = self:GetAbility():GetAbilityDamageType(),
								damage_flags = DOTA_DAMAGE_FLAG_PROPERTY_FIRE, --Optional.
								ability = self:GetAbility(), --Optional.
								}
...
LinkLuaModifier("modifier_imba_fiery_soul_stacks", "ability/abilities_lua/hero_lina", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_fiery_soul_active", "ability/abilities_lua/hero_lina", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_fiery_soul_passive", "ability/abilities_lua/hero_lina", LUA_MODIFIER_MOTION_NONE)
...
imba_lina_laguna_blade_b = class({})

function imba_lina_laguna_blade_b:IsHiddenWhenStolen() 		return false end
function imba_lina_laguna_blade_b:IsRefreshable() 			return true end
function imba_lina_laguna_blade_b:IsStealable() 			return true end
function imba_lina_laguna_blade_b:IsNetherWardStealable()	return true end
function imba_lina_laguna_blade_b:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_laguna_blade_b:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_laguna_blade_b:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_laguna_blade_fiery" or "lina_laguna_blade" end

function imba_lina_laguna_blade_b:OnSpellStart()
	local caster = self:GetCaster()
...
function imba_lina_laguna_blade_b:OnProjectileHit(target, location)
	if not target then
	...
	for _, enemy in pairs(enemies) do
		local damageTable = {
							victim = enemy,
							attacker = self:GetCaster(),
							damage = dmg + self:GetCaster():GetStrength() * attr_scale,
							damage_type = dmgType,
...
imba_lina_laguna_blade_a = class({})

function imba_lina_laguna_blade_a:IsHiddenWhenStolen() 		return false end
function imba_lina_laguna_blade_a:IsRefreshable() 			return true end
function imba_lina_laguna_blade_a:IsStealable() 			return true end
function imba_lina_laguna_blade_a:IsNetherWardStealable()	return true end
function imba_lina_laguna_blade_a:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_laguna_blade_a:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_laguna_blade_a:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_laguna_blade_fiery" or "lina_laguna_blade" end

function imba_lina_laguna_blade_a:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
		return
...
function imba_lina_laguna_blade_a:OnProjectileHit(target, location)
	if not target then
		target = CreateModifierThinker(self:GetCaster(), nil, "modifier_dummy_thinker", {duration = 1.0}, location, self:GetCaster():GetTeamNumber(), false)
	end
	local caster = self:GetCaster()
...
imba_lina_laguna_blade_s = class({})

function imba_lina_laguna_blade_s:IsHiddenWhenStolen() 		return false end
function imba_lina_laguna_blade_s:IsRefreshable() 			return true end
function imba_lina_laguna_blade_s:IsStealable() 			return true end
function imba_lina_laguna_blade_s:IsNetherWardStealable()	return true end
function imba_lina_laguna_blade_s:GetManaCost(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("mana_super") or self:GetSpecialValueFor("mana_normal") end
function imba_lina_laguna_blade_s:GetCooldown(a) return self:HasFireSoulActive() and self:GetSpecialValueFor("cd_super") or self:GetSpecialValueFor("cd_normal") end
function imba_lina_laguna_blade_s:GetAbilityTextureName() return self:HasFireSoulActive() and "lina_laguna_blade_fiery" or "lina_laguna_blade" end

function imba_lina_laguna_blade_s:OnSpellStart()
	local caster = self:GetCaster()
	local target = self:GetCursorTarget()
	if target:TriggerStandardTargetSpell(self) then
		return
...
function imba_lina_laguna_blade_s:OnProjectileHit(target, location)
	if not target then
		target = CreateModifierThinker(self:GetCaster(), nil, "modifier_dummy_thinker", {duration = 1.0}, location, self:GetCaster():GetTeamNumber(), false)
	end
	local caster = self:GetCaster()
