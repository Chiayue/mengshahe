active_line_magical_int_lua_c = class({})

--------------------------------------------------------------------------------

function active_line_magical_int_lua_c:OnSpellStart()
...
function active_line_magical_int_lua_c:OnProjectileHit( hTarget, vLocation )
