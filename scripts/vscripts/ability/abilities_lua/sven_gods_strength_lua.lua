...
LinkLuaModifier( "modifier_sven_gods_strength_lua", "ability/abilities_lua/modifier/modifier_sven_gods_strength_lua",LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sven_gods_strength_child_lua", "ability/abilities_lua/modifier/modifier_sven_gods_strength_child_lua",LUA_MODIFIER_MOTION_NONE )
