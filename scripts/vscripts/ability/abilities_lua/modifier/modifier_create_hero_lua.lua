modifier_create_hero_lua = class({})
--------------------------------------------------------------------------------

function modifier_create_hero_lua:DeclareFunctions()
    local funcs = {
    }
    return funcs
end

function modifier_create_hero_lua:IsHidden()
    return true
end
function modifier_create_hero_lua:OnCreated( kv )
	if IsServer() then
