tg_jk_db_s=tg_jk_db_s or class({})
...
function tg_jk_db_s:IsHiddenWhenStolen() 
    return false 
end

function tg_jk_db_s:IsStealable() 
    return true 
end

function tg_jk_db_s:IsNetherWardStealable() 
    return true 
end

function tg_jk_db_s:IsRefreshable() 			
    return true 
end

function tg_jk_db_s:ProcsMagicStick() 			
    return true 
end

function tg_jk_db_s:OnSpellStart()
...
function tg_jk_db_s:OnProjectileHit_ExtraData(target, location, kv)
