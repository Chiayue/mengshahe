...
LinkLuaModifier( "modifier_sven_storm_bolt_lua", "ability/abilities_lua/modifier/modifier_sven_storm_bolt_lua",LUA_MODIFIER_MOTION_NONE )
			...
			for _,enemy in pairs(enemies) do
				if enemy ~= nil and ( not enemy:IsMagicImmune() ) and ( not enemy:IsInvulnerable() ) then
					...
					local damage = {
						...
						damage = bolt_damage + self:GetCaster():GetIntellect() * self.bonuses_scale,
